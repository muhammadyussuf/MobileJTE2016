package id.ac.unsyiah.elektro.tesmobile.contohsharedpref;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tulis = (TextView) findViewById(R.id.txtcounter);
        tulis.setText(counterHidupStr);
    ...
    private int ambilCounterhidup(){
        SharedPreferences sharedPreferences =
                getSharedPreferences("id.ac.unsyiah.elektro.mobile.PREF_BERSAMA",
