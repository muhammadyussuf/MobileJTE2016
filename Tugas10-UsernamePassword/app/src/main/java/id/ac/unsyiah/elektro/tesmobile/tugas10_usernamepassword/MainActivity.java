...
public class MainActivity extends AppCompatActivity {
    ...
    public void onMasuk (View view){
        SharedPreferences sharedPreferences =
                getSharedPreferences("id.ac.unsyiah.elektro.tesmobile.tugas10_usernamepassword.PREF_BERSAMA", Context.MODE_PRIVATE);
        ...
        EditText pass = (EditText) findViewById(R.id.key);
